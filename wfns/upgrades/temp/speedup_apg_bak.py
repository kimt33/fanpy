...
from wfns.wfn.geminal.apg2 import APG2
from wfns.wfn.geminal.apg3 import APG3
from wfns.wfn.geminal.apg4 import APG4
from wfns.wfn.geminal.apg5 import APG5
from wfns.wfn.geminal.apg6 import APG6
import wfns.backend.slater as slater
# import wfns.backend.graphs as graphs
import numpy as np
from cext_apg import _olp_internal, generate_complete_pmatch, generate_general_pmatch
...
def _olp(self, sd):
    ...
    output = _olp_internal(orbpair_generator, self.params, self.dict_orbpair_ind)

    if abs(output) > self.essential_olp_threshold:
        self.essential_sds[sd] = output
    elif abs(output) > self.optional_olp_threshold:
        self.optional_sds[sd] = output
