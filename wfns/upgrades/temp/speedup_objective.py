...
from cext_apg import _olp_deriv_internal_ap1rog
from cext_apg_parallel import _olp_deriv_internal, _olp_deriv_internal_apig
from cext_apg import _olp_deriv_internal as _olp_deriv_check
...
def gradient_energy(self, params, parallel=None, assign=True, normalize=False, save=True):
    params = np.array(params)
    # Assign params
    if assign:
        self.assign_params(params)
