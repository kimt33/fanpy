...
class OneSidedEnergySystem(SystemEquations):
    ...
    def objective(self, params):
        ...
        system_eqns, energy = super().objective(params, return_energy=True, normalize=True)
        ...
        return np.sum(system_eqns ** 2) + energy * self.energy_weight
    ...
    def gradient(self, params):
        ...
        system_eqns_jac, system_eqns, energy, d_energy = super().jacobian(params, return_d_energy=True)
