...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "wfns.upgrades.cext_apg_parallel2",
        "sources": [
            "wfns/upgrades/cext_apg_parallel2.pyx"
        ]
    },
    "module_name": "wfns.upgrades.cext_apg_parallel2"
}
END: Cython Metadata */
...
#define __PYX_HAVE__wfns__upgrades__cext_apg_parallel2
#define __PYX_HAVE_API__wfns__upgrades__cext_apg_parallel2
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'wfns.upgrades.cext_apg_parallel2' */
...
static double __pyx_f_4wfns_8upgrades_18cext_apg_parallel2_ryser(__Pyx_memviewslice, __Pyx_memviewslice, int); /*proto*/
static void __pyx_f_4wfns_8upgrades_18cext_apg_parallel2_ryser_deriv(__Pyx_memviewslice, __Pyx_memviewslice, long, int, double *); /*proto*/
static long __pyx_f_4wfns_8upgrades_18cext_apg_parallel2_countbits(unsigned long); /*proto*/
static long __pyx_f_4wfns_8upgrades_18cext_apg_parallel2_bitparity(unsigned long); /*proto*/
...
#define __Pyx_MODULE_NAME "wfns.upgrades.cext_apg_parallel2"
extern int __pyx_module_is_main_wfns__upgrades__cext_apg_parallel2;
int __pyx_module_is_main_wfns__upgrades__cext_apg_parallel2 = 0;

/* Implementation of 'wfns.upgrades.cext_apg_parallel2' */
...
static const char __pyx_k_wfns_upgrades_cext_apg_parallel2[] = "wfns/upgrades/cext_apg_parallel2.pyx";
static const char __pyx_k_wfns_upgrades_cext_apg_parallel2_2[] = "wfns.upgrades.cext_apg_parallel2";
...
static PyObject *__pyx_kp_s_wfns_upgrades_cext_apg_parallel2;
static PyObject *__pyx_n_s_wfns_upgrades_cext_apg_parallel2_2;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_4wfns_8upgrades_18cext_apg_parallel2__olp_internal(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_orbpairs_sign, __Pyx_memviewslice __pyx_v_params, long __pyx_v_nspin); /* proto */
static PyObject *__pyx_pf_4wfns_8upgrades_18cext_apg_parallel2_2_olp_deriv_internal(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_orbpairs_sign, __Pyx_memviewslice __pyx_v_params, long __pyx_v_nspin); /* proto */
...
/* "wfns/upgrades/cext_apg_parallel2.pyx":34
...
static double __pyx_f_4wfns_8upgrades_18cext_apg_parallel2_ryser(__Pyx_memviewslice __pyx_v_submatrix, __Pyx_memviewslice __pyx_v_orbpairs, int __pyx_v_nspin) {
  int __pyx_v_n;
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":35
 * @cython.wraparound(False)   # Deactivate negative indexing.
 * cdef double ryser(double[:, :] submatrix, long[:] orbpairs, int nspin) nogil:
 *     cdef int n = submatrix.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":38
 * 
 *     # cdef long col_inds[npairs]
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":40
 *     cdef long *col_inds = <long *> malloc(sizeof(long) * n)
 *     cdef int i, j, k
 *     for k in range(n):             # <<<<<<<<<<<<<<
 *         i = orbpairs[2 * k]
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":41
 *     cdef int i, j, k
 *     for k in range(n):
 *         i = orbpairs[2 * k]             # <<<<<<<<<<<<<<
 *         j = orbpairs[2 * k + 1]
 ...
 */
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":42
 *     for k in range(n):
 *         i = orbpairs[2 * k]
 *         j = orbpairs[2 * k + 1]             # <<<<<<<<<<<<<<
 *         col_inds[k] = nspin * i - i * (i + 1) // 2 + (j - i - 1)
 ...
 */
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":43
 *         i = orbpairs[2 * k]
 *         j = orbpairs[2 * k + 1]
 *         col_inds[k] = nspin * i - i * (i + 1) // 2 + (j - i - 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":46
 * 
 *     cdef double rowsum, rowsumprod
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":47
 *     cdef double rowsum, rowsumprod
 *     cdef double perm = 0.0
 *     cdef unsigned long exp = 1 << n             # <<<<<<<<<<<<<<
 *     cdef unsigned long x
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":50
 *     cdef unsigned long x
 *     cdef unsigned long y, z, z_matrix
 *     for x in range(exp):             # <<<<<<<<<<<<<<
 *         rowsumprod = 1.0
 ...
 */
  ...
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":51
 *     cdef unsigned long y, z, z_matrix
 *     for x in range(exp):
 *         rowsumprod = 1.0             # <<<<<<<<<<<<<<
 *         for y in range(n):
 ...
 */
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":52
 *     for x in range(exp):
 *         rowsumprod = 1.0
 *         for y in range(n):             # <<<<<<<<<<<<<<
 *             rowsum = 0.0
 ...
 */
    ...
    for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_2; __pyx_t_8+=1) {
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":53
 *         rowsumprod = 1.0
 *         for y in range(n):
 *             rowsum = 0.0             # <<<<<<<<<<<<<<
 *             for z in range(n):
 ...
 */
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":54
 *         for y in range(n):
 *             rowsum = 0.0
 *             for z in range(n):             # <<<<<<<<<<<<<<
 *                 z_matrix = col_inds[z]
 ...
 */
      ...
      for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":55
 *             rowsum = 0.0
 *             for z in range(n):
 *                 z_matrix = col_inds[z]             # <<<<<<<<<<<<<<
 *                 if x & (1 << z) != 0:
 ...
 */
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":56
 *             for z in range(n):
 *                 z_matrix = col_inds[z]
 *                 if x & (1 << z) != 0:             # <<<<<<<<<<<<<<
 *                     rowsum += submatrix[y, z_matrix]
 ...
 */
        ...
        if (__pyx_t_11) {
          ...
          /* "wfns/upgrades/cext_apg_parallel2.pyx":57
 *                 z_matrix = col_inds[z]
 *                 if x & (1 << z) != 0:
 *                     rowsum += submatrix[y, z_matrix]             # <<<<<<<<<<<<<<
 *             rowsumprod *= rowsum
 ...
 */
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":58
 *                 if x & (1 << z) != 0:
 *                     rowsum += submatrix[y, z_matrix]
 *             rowsumprod *= rowsum             # <<<<<<<<<<<<<<
 *         perm += rowsumprod * bitparity(x)
 ...
 */
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":59
 *                     rowsum += submatrix[y, z_matrix]
 *             rowsumprod *= rowsum
 *         perm += rowsumprod * bitparity(x)             # <<<<<<<<<<<<<<
 *     if n % 2 == 1:
 *         perm *= -1
 */
    __pyx_v_perm = (__pyx_v_perm + (__pyx_v_rowsumprod * __pyx_f_4wfns_8upgrades_18cext_apg_parallel2_bitparity(__pyx_v_x)));
  }

  /* "wfns/upgrades/cext_apg_parallel2.pyx":60
 *             rowsumprod *= rowsum
 *         perm += rowsumprod * bitparity(x)
 *     if n % 2 == 1:             # <<<<<<<<<<<<<<
 *         perm *= -1
 ...
 */
  ...
  if (__pyx_t_11) {
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":61
 *         perm += rowsumprod * bitparity(x)
 *     if n % 2 == 1:
 *         perm *= -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":63
 *         perm *= -1
 * 
 *     free(col_inds)             # <<<<<<<<<<<<<<
 *     return perm
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":64
 * 
 *     free(col_inds)
 *     return perm             # <<<<<<<<<<<<<<
 * 
...
/* "wfns/upgrades/cext_apg_parallel2.pyx":69
 * @cython.boundscheck(False)  # Deactivate bounds checking
 * @cython.wraparound(False)   # Deactivate negative indexing.
...
static void __pyx_f_4wfns_8upgrades_18cext_apg_parallel2_ryser_deriv(__Pyx_memviewslice __pyx_v_submatrix, __Pyx_memviewslice __pyx_v_orbpairs, long __pyx_v_sign, int __pyx_v_nspin, double *__pyx_v_deriv) {
  int __pyx_v_n;
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":76
 *     double* deriv,
 * ) nogil:
 *     cdef int n = submatrix.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":77
 * ) nogil:
 *     cdef int n = submatrix.shape[0]
 *     cdef int num_orbpairs = submatrix.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":80
 * 
 *     # cdef long col_inds[npairs]
 *     cdef long *col_inds = <long *> malloc(sizeof(long) * n)             # <<<<<<<<<<<<<<
 *     cdef int i, j, k
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":82
 *     cdef long *col_inds = <long *> malloc(sizeof(long) * n)
 *     cdef int i, j, k
 *     for k in range(n):             # <<<<<<<<<<<<<<
 *         i = orbpairs[2 * k]
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":83
 *     cdef int i, j, k
 *     for k in range(n):
 *         i = orbpairs[2 * k]             # <<<<<<<<<<<<<<
 *         j = orbpairs[2 * k + 1]
 ...
 */
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":84
 *     for k in range(n):
 *         i = orbpairs[2 * k]
 *         j = orbpairs[2 * k + 1]             # <<<<<<<<<<<<<<
 *         col_inds[k] = nspin * i - i * (i + 1) // 2 + (j - i - 1)
 ...
 */
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":85
 *         i = orbpairs[2 * k]
 *         j = orbpairs[2 * k + 1]
 *         col_inds[k] = nspin * i - i * (i + 1) // 2 + (j - i - 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":89
 *     cdef double rowsum
 *     # cdef double perm = 0.0
 *     cdef unsigned long exp = 1 << n             # <<<<<<<<<<<<<<
 *     cdef unsigned long x
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":94
 * 
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":96
 *     cdef double *rowsum_vec = <double *> malloc(sizeof(double) * n)
 *     # cdef double rowsumprod[npairs_squared]
 *     cdef double *rowsumprod = <double *> malloc(sizeof(double) * n ** 2)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":97
 *     # cdef double rowsumprod[npairs_squared]
 *     cdef double *rowsumprod = <double *> malloc(sizeof(double) * n ** 2)
 *     cdef double temp = 1.0             # <<<<<<<<<<<<<<
 *     # cdef double rowsumprod_vec[npairs_squared]
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":99
 *     cdef double temp = 1.0
 *     # cdef double rowsumprod_vec[npairs_squared]
 *     cdef double *rowsumprod_vec = <double *> malloc(sizeof(double) * n ** 2)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":101
 *     cdef double *rowsumprod_vec = <double *> malloc(sizeof(double) * n ** 2)
 *     # cdef double perm_vec[npairs_squared]
 *     cdef double *perm_vec = <double *> malloc(sizeof(double) * n ** 2)             # <<<<<<<<<<<<<<
 *     cdef int p, q
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":104
 *     cdef int p, q
 * 
 *     for p in range(n):             # <<<<<<<<<<<<<<
 *         for q in range(n):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":105
 * 
 *     for p in range(n):
 *         for q in range(n):             # <<<<<<<<<<<<<<
 *             perm_vec[p * n + q] = 0.0
 ...
 */
    ...
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":106
 *     for p in range(n):
 *         for q in range(n):
 *             perm_vec[p * n + q] = 0.0             # <<<<<<<<<<<<<<
 *     for x in range(exp):
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":107
 *         for q in range(n):
 *             perm_vec[p * n + q] = 0.0
 *     for x in range(exp):             # <<<<<<<<<<<<<<
 *         # rowsumprod = 1.0
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":109
 *     for x in range(exp):
 *         # rowsumprod = 1.0
 *         for p in range(n):             # <<<<<<<<<<<<<<
 *             for q in range(n):
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":110
 *         # rowsumprod = 1.0
 *         for p in range(n):
 *             for q in range(n):             # <<<<<<<<<<<<<<
 *                 rowsumprod[p * n + q] = 1.0
 ...
 */
      ...
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":111
 *         for p in range(n):
 *             for q in range(n):
 *                 rowsumprod[p * n + q] = 1.0             # <<<<<<<<<<<<<<
 *                 rowsumprod_vec[p * n + q] = 1.0
 ...
 */
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":112
 *             for q in range(n):
 *                 rowsumprod[p * n + q] = 1.0
 *                 rowsumprod_vec[p * n + q] = 1.0             # <<<<<<<<<<<<<<
 *         for y in range(n):
 ...
 */
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":113
 *                 rowsumprod[p * n + q] = 1.0
 *                 rowsumprod_vec[p * n + q] = 1.0
 *         for y in range(n):             # <<<<<<<<<<<<<<
 *             rowsum = 0.0
 ...
 */
    ...
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_2; __pyx_t_11+=1) {
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":114
 *                 rowsumprod_vec[p * n + q] = 1.0
 *         for y in range(n):
 *             rowsum = 0.0             # <<<<<<<<<<<<<<
 *             for q in range(n):
 ...
 */
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":115
 *         for y in range(n):
 *             rowsum = 0.0
 *             for q in range(n):             # <<<<<<<<<<<<<<
 *                 rowsum_vec[q] = 0.0
 ...
 */
      ...
      for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":116
 *             rowsum = 0.0
 *             for q in range(n):
 *                 rowsum_vec[q] = 0.0             # <<<<<<<<<<<<<<
 *             for z in range(n):
 ...
 */
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":117
 *             for q in range(n):
 *                 rowsum_vec[q] = 0.0
 *             for z in range(n):             # <<<<<<<<<<<<<<
 *                 z_matrix = col_inds[z]
 ...
 */
      ...
      for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_5; __pyx_t_12+=1) {
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":118
 *                 rowsum_vec[q] = 0.0
 *             for z in range(n):
 *                 z_matrix = col_inds[z]             # <<<<<<<<<<<<<<
 *                 # if x includes z
 ...
 */
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":120
 *                 z_matrix = col_inds[z]
 *                 # if x includes z
 *                 if x & (1 << z) != 0:             # <<<<<<<<<<<<<<
 *                     rowsum += submatrix[y, z_matrix]
 ...
 */
        ...
        if (__pyx_t_13) {
          ...
          /* "wfns/upgrades/cext_apg_parallel2.pyx":121
 *                 # if x includes z
 *                 if x & (1 << z) != 0:
 *                     rowsum += submatrix[y, z_matrix]             # <<<<<<<<<<<<<<
 *                     rowsum_vec[z] = submatrix[y, z_matrix]
 ...
 */
          ...
          /* "wfns/upgrades/cext_apg_parallel2.pyx":122
 *                 if x & (1 << z) != 0:
 *                     rowsum += submatrix[y, z_matrix]
 *                     rowsum_vec[z] = submatrix[y, z_matrix]             # <<<<<<<<<<<<<<
 *             # rowsumprod *= rowsum
 ...
 */
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":124
 *                     rowsum_vec[z] = submatrix[y, z_matrix]
 *             # rowsumprod *= rowsum
 *             for q in range(n):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":127
 *                 # fixe: can't handle zeros
 *                 # rowsumprod[q] *= rowsum - rowsum_vec[q]
 ...
 */
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":131
 *         # create array such that each element (i, j) is a product of elements in column j except
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":132
 *         # for element at row i
 *         for q in range(n):
 *             temp = 1.0             # <<<<<<<<<<<<<<
 *             for p in range(n):
 ...
 */
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":133
 *         for q in range(n):
 *             temp = 1.0
 *             for p in range(n):             # <<<<<<<<<<<<<<
 *                 rowsumprod[p * n + q] *= temp
 ...
 */
      ...
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":134
 *             temp = 1.0
 *             for p in range(n):
 *                 rowsumprod[p * n + q] *= temp             # <<<<<<<<<<<<<<
 *                 temp *= rowsumprod_vec[p * n + q]
 ...
 */
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":135
 *             for p in range(n):
 *                 rowsumprod[p * n + q] *= temp
 *                 temp *= rowsumprod_vec[p * n + q]             # <<<<<<<<<<<<<<
 *             temp = 1.0
 ...
 */
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":136
 *                 rowsumprod[p * n + q] *= temp
 *                 temp *= rowsumprod_vec[p * n + q]
 *             temp = 1.0             # <<<<<<<<<<<<<<
 *             for p in range(n - 1, -1, -1):
 ...
 */
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":137
 *                 temp *= rowsumprod_vec[p * n + q]
 *             temp = 1.0
 *             for p in range(n - 1, -1, -1):             # <<<<<<<<<<<<<<
 *                 rowsumprod[p * n + q] *= temp
 ...
 */
      for (__pyx_t_5 = (__pyx_v_n - 1); __pyx_t_5 > -1; __pyx_t_5-=1) {
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":138
 *             temp = 1.0
 *             for p in range(n - 1, -1, -1):
 *                 rowsumprod[p * n + q] *= temp             # <<<<<<<<<<<<<<
 *                 temp *= rowsumprod_vec[p * n + q]
 ...
 */
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":139
 *             for p in range(n - 1, -1, -1):
 *                 rowsumprod[p * n + q] *= temp
 *                 temp *= rowsumprod_vec[p * n + q]             # <<<<<<<<<<<<<<
 *         # perm += rowsumprod * bitparity(x)
 ...
 */
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":141
 *                 temp *= rowsumprod_vec[p * n + q]
 *         # perm += rowsumprod * bitparity(x)
 *         for p in range(n):             # <<<<<<<<<<<<<<
 *             for q in range(n):
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":142
 *         # perm += rowsumprod * bitparity(x)
 *         for p in range(n):
 *             for q in range(n):             # <<<<<<<<<<<<<<
 *                 # if x excludes q
 ...
 */
      ...
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":145
 *                 # if x excludes q
 *                 # if x & (1 << q) == 0 and rowsumprod_vec[p * n + q] != 0:
 *                 if x & (1 << q) == 0:             # <<<<<<<<<<<<<<
 ...
 */
        ...
        if (__pyx_t_13) {
          ...
          /* "wfns/upgrades/cext_apg_parallel2.pyx":146
 *                 # if x & (1 << q) == 0 and rowsumprod_vec[p * n + q] != 0:
 *                 if x & (1 << q) == 0:
 *                     perm_vec[p * n + q] += rowsumprod[p * n + q] * (-bitparity(x))             # <<<<<<<<<<<<<<
 *     if n % 2 == 1:
 ...
 */
          __pyx_t_16 = ((__pyx_v_p * __pyx_v_n) + __pyx_v_q);
          (__pyx_v_perm_vec[__pyx_t_16]) = ((__pyx_v_perm_vec[__pyx_t_16]) + ((__pyx_v_rowsumprod[((__pyx_v_p * __pyx_v_n) + __pyx_v_q)]) * (-__pyx_f_4wfns_8upgrades_18cext_apg_parallel2_bitparity(__pyx_v_x))));
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":147
 *                 if x & (1 << q) == 0:
 *                     perm_vec[p * n + q] += rowsumprod[p * n + q] * (-bitparity(x))
 *     if n % 2 == 1:             # <<<<<<<<<<<<<<
 *         # perm *= -1
 ...
 */
  ...
  if (__pyx_t_13) {
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":149
 *     if n % 2 == 1:
 *         # perm *= -1
 *         for p in range(n):             # <<<<<<<<<<<<<<
 *             for q in range(n):
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":150
 *         # perm *= -1
 *         for p in range(n):
 *             for q in range(n):             # <<<<<<<<<<<<<<
 *                 perm_vec[p * n + q] *= -1
 ...
 */
      ...
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
        ...
        /* "wfns/upgrades/cext_apg_parallel2.pyx":151
 *         for p in range(n):
 *             for q in range(n):
 *                 perm_vec[p * n + q] *= -1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":153
 *                 perm_vec[p * n + q] *= -1
 * 
 *     for p in range(n):             # <<<<<<<<<<<<<<
 *         for q in range(n):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "wfns/upgrades/cext_apg_parallel2.pyx":154
 * 
 *     for p in range(n):
 *         for q in range(n):             # <<<<<<<<<<<<<<
 *             # deriv[p * num_orbpairs + col_inds[q]] += sign * perm_vec[p * n + q]
 ...
 */
    ...
    for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
      ...
      /* "wfns/upgrades/cext_apg_parallel2.pyx":156
 *         for q in range(n):
 *             # deriv[p * num_orbpairs + col_inds[q]] += sign * perm_vec[p * n + q]
 *             deriv[p * n + q] += sign * perm_vec[p * n + q]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":158
 *             deriv[p * n + q] += sign * perm_vec[p * n + q]
 * 
 *     free(col_inds)             # <<<<<<<<<<<<<<
 *     free(rowsum_vec)
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":159
 * 
 *     free(col_inds)
 *     free(rowsum_vec)             # <<<<<<<<<<<<<<
 *     free(rowsumprod)
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":160
 *     free(col_inds)
 *     free(rowsum_vec)
 *     free(rowsumprod)             # <<<<<<<<<<<<<<
 *     free(rowsumprod_vec)
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":161
 *     free(rowsum_vec)
 *     free(rowsumprod)
 *     free(rowsumprod_vec)             # <<<<<<<<<<<<<<
 *     free(perm_vec)
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":162
 *     free(rowsumprod)
 *     free(rowsumprod_vec)
 *     free(perm_vec)             # <<<<<<<<<<<<<<
 * 
...
/* "wfns/upgrades/cext_apg_parallel2.pyx":166
 * @cython.boundscheck(False)  # Deactivate bounds checking
 * @cython.wraparound(False)   # Deactivate negative indexing.
...
static long __pyx_f_4wfns_8upgrades_18cext_apg_parallel2_countbits(unsigned long __pyx_v_n) {
  unsigned long __pyx_v_q;
  long __pyx_r;

  /* "wfns/upgrades/cext_apg_parallel2.pyx":167
 * @cython.wraparound(False)   # Deactivate negative indexing.
 * cdef long countbits(unsigned long n) nogil:
 *     cdef unsigned long q = n             # <<<<<<<<<<<<<<
 *     q = (q & <unsigned long>0x5555555555555555) + ((q & <unsigned long>0xAAAAAAAAAAAAAAAA) >> 1)
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":168
 * cdef long countbits(unsigned long n) nogil:
 *     cdef unsigned long q = n
 *     q = (q & <unsigned long>0x5555555555555555) + ((q & <unsigned long>0xAAAAAAAAAAAAAAAA) >> 1)             # <<<<<<<<<<<<<<
 *     q = (q & <unsigned long>0x3333333333333333) + ((q & <unsigned long>0xCCCCCCCCCCCCCCCC) >> 2)
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":169
 *     cdef unsigned long q = n
 *     q = (q & <unsigned long>0x5555555555555555) + ((q & <unsigned long>0xAAAAAAAAAAAAAAAA) >> 1)
 *     q = (q & <unsigned long>0x3333333333333333) + ((q & <unsigned long>0xCCCCCCCCCCCCCCCC) >> 2)             # <<<<<<<<<<<<<<
 *     q = (q & <unsigned long>0x0F0F0F0F0F0F0F0F) + ((q & <unsigned long>0xF0F0F0F0F0F0F0F0) >> 4)
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":170
 *     q = (q & <unsigned long>0x5555555555555555) + ((q & <unsigned long>0xAAAAAAAAAAAAAAAA) >> 1)
 *     q = (q & <unsigned long>0x3333333333333333) + ((q & <unsigned long>0xCCCCCCCCCCCCCCCC) >> 2)
 *     q = (q & <unsigned long>0x0F0F0F0F0F0F0F0F) + ((q & <unsigned long>0xF0F0F0F0F0F0F0F0) >> 4)             # <<<<<<<<<<<<<<
 *     q = (q & <unsigned long>0x00FF00FF00FF00FF) + ((q & <unsigned long>0xFF00FF00FF00FF00) >> 8)
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":171
 *     q = (q & <unsigned long>0x3333333333333333) + ((q & <unsigned long>0xCCCCCCCCCCCCCCCC) >> 2)
 *     q = (q & <unsigned long>0x0F0F0F0F0F0F0F0F) + ((q & <unsigned long>0xF0F0F0F0F0F0F0F0) >> 4)
 *     q = (q & <unsigned long>0x00FF00FF00FF00FF) + ((q & <unsigned long>0xFF00FF00FF00FF00) >> 8)             # <<<<<<<<<<<<<<
 *     q = (q & <unsigned long>0x0000FFFF0000FFFF) + ((q & <unsigned long>0xFFFF0000FFFF0000) >> 16)
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":172
 *     q = (q & <unsigned long>0x0F0F0F0F0F0F0F0F) + ((q & <unsigned long>0xF0F0F0F0F0F0F0F0) >> 4)
 *     q = (q & <unsigned long>0x00FF00FF00FF00FF) + ((q & <unsigned long>0xFF00FF00FF00FF00) >> 8)
 *     q = (q & <unsigned long>0x0000FFFF0000FFFF) + ((q & <unsigned long>0xFFFF0000FFFF0000) >> 16)             # <<<<<<<<<<<<<<
 *     # This last & isn't strictly necessary.
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":174
 *     q = (q & <unsigned long>0x0000FFFF0000FFFF) + ((q & <unsigned long>0xFFFF0000FFFF0000) >> 16)
 *     # This last & isn't strictly necessary.
 *     q = (q & <unsigned long>0x00000000FFFFFFFF) + ((q & <unsigned long>0xFFFFFFFF00000000) >> 32)             # <<<<<<<<<<<<<<
 *     return q;
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":175
 *     # This last & isn't strictly necessary.
 *     q = (q & <unsigned long>0x00000000FFFFFFFF) + ((q & <unsigned long>0xFFFFFFFF00000000) >> 32)
 *     return q;             # <<<<<<<<<<<<<<
 * 
...
/* "wfns/upgrades/cext_apg_parallel2.pyx":179
 * @cython.boundscheck(False)  # Deactivate bounds checking
 * @cython.wraparound(False)   # Deactivate negative indexing.
...
static long __pyx_f_4wfns_8upgrades_18cext_apg_parallel2_bitparity(unsigned long __pyx_v_n) {
  long __pyx_r;

  /* "wfns/upgrades/cext_apg_parallel2.pyx":180
 * @cython.wraparound(False)   # Deactivate negative indexing.
 * cdef long bitparity (unsigned long n) nogil:
 *     return 1 - (countbits(n) & 1)*2             # <<<<<<<<<<<<<<
 * 
 * @cython.boundscheck(False)  # Deactivate bounds checking
 */
  __pyx_r = (1 - ((__pyx_f_4wfns_8upgrades_18cext_apg_parallel2_countbits(__pyx_v_n) & 1) * 2));
  goto __pyx_L0;
...
/* "wfns/upgrades/cext_apg_parallel2.pyx":184
 * @cython.boundscheck(False)  # Deactivate bounds checking
 * @cython.wraparound(False)   # Deactivate negative indexing.
...
/* Python wrapper */
static PyObject *__pyx_pw_4wfns_8upgrades_18cext_apg_parallel2_1_olp_internal(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4wfns_8upgrades_18cext_apg_parallel2_1_olp_internal = {"_olp_internal", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4wfns_8upgrades_18cext_apg_parallel2_1_olp_internal, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4wfns_8upgrades_18cext_apg_parallel2_1_olp_internal(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("wfns.upgrades.cext_apg_parallel2._olp_internal", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_4wfns_8upgrades_18cext_apg_parallel2__olp_internal(__pyx_self, __pyx_v_orbpairs_sign, __pyx_v_params, __pyx_v_nspin);
...
static PyObject *__pyx_pf_4wfns_8upgrades_18cext_apg_parallel2__olp_internal(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_orbpairs_sign, __Pyx_memviewslice __pyx_v_params, long __pyx_v_nspin) {
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":185
 * @cython.wraparound(False)   # Deactivate negative indexing.
 * def _olp_internal(list orbpairs_sign, double[:, :] params, long nspin):
 *     cdef long[:, :] orbpairs_sign_view = np.array(orbpairs_sign)             # <<<<<<<<<<<<<<
 *     cdef int nelec = 2 * params.shape[0]
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":186
 * def _olp_internal(list orbpairs_sign, double[:, :] params, long nspin):
 *     cdef long[:, :] orbpairs_sign_view = np.array(orbpairs_sign)
 *     cdef int nelec = 2 * params.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":188
 *     cdef int nelec = 2 * params.shape[0]
 * 
 *     cdef double output = 0.0             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t i
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":190
 *     cdef double output = 0.0
 *     cdef Py_ssize_t i
 *     for i in prange(orbpairs_sign_view.shape[0], nogil=True, schedule='static'):             # <<<<<<<<<<<<<<
                ...
                #endif /* _OPENMP */
                {
                    ...
                    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_7; __pyx_t_6++){
                        if (__pyx_parallel_why < 2)
                        {
                            ...
                            /* "wfns/upgrades/cext_apg_parallel2.pyx":193
 *     # for i in range(orbpairs_sign_view.shape[0]):
 *         output += (
 ...
 */
                            ...
                            /* "wfns/upgrades/cext_apg_parallel2.pyx":195
 *             orbpairs_sign_view[i, nelec] *
 *             # ryser(params, col_inds_apg(orbpairs_sign_view[i, :nelec], nspin))
 *             ryser(params, orbpairs_sign_view[i, :nelec], nspin)             # <<<<<<<<<<<<<<
 *         )
...
__pyx_v_output = (__pyx_v_output + ((*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_orbpairs_sign_view.data + __pyx_t_8 * __pyx_v_orbpairs_sign_view.strides[0]) ) + __pyx_t_9 * __pyx_v_orbpairs_sign_view.strides[1]) ))) * __pyx_f_4wfns_8upgrades_18cext_apg_parallel2_ryser(__pyx_v_params, __pyx_t_10, __pyx_v_nspin)));

                            /* "wfns/upgrades/cext_apg_parallel2.pyx":192
 *     for i in prange(orbpairs_sign_view.shape[0], nogil=True, schedule='static'):
 *     # for i in range(orbpairs_sign_view.shape[0]):
 *         output += (             # <<<<<<<<<<<<<<
 *             orbpairs_sign_view[i, nelec] *
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":197
 *             ryser(params, orbpairs_sign_view[i, :nelec], nspin)
 *         )
 *     return output             # <<<<<<<<<<<<<<
 * 
...
/* "wfns/upgrades/cext_apg_parallel2.pyx":202
 * @cython.boundscheck(False)  # Deactivate bounds checking
 * @cython.wraparound(False)   # Deactivate negative indexing.
...
/* Python wrapper */
static PyObject *__pyx_pw_4wfns_8upgrades_18cext_apg_parallel2_3_olp_deriv_internal(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4wfns_8upgrades_18cext_apg_parallel2_3_olp_deriv_internal = {"_olp_deriv_internal", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4wfns_8upgrades_18cext_apg_parallel2_3_olp_deriv_internal, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4wfns_8upgrades_18cext_apg_parallel2_3_olp_deriv_internal(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_orbpairs_sign = 0;
  __Pyx_memviewslice __pyx_v_params = { 0, 0, { 0 }, { 0 }, { 0 } };
  long __pyx_v_nspin;
  int __pyx_lineno = 0;
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("wfns.upgrades.cext_apg_parallel2._olp_deriv_internal", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  ...
  __pyx_r = __pyx_pf_4wfns_8upgrades_18cext_apg_parallel2_2_olp_deriv_internal(__pyx_self, __pyx_v_orbpairs_sign, __pyx_v_params, __pyx_v_nspin);
...
static PyObject *__pyx_pf_4wfns_8upgrades_18cext_apg_parallel2_2_olp_deriv_internal(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_orbpairs_sign, __Pyx_memviewslice __pyx_v_params, long __pyx_v_nspin) {
  __Pyx_memviewslice __pyx_v_orbpairs_sign_view = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_npair;
  int __pyx_v_nelec;
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":203
 * @cython.wraparound(False)   # Deactivate negative indexing.
 * def _olp_deriv_internal(list orbpairs_sign, double[:, :] params, long nspin):
 *     cdef long[:, :] orbpairs_sign_view = np.array(orbpairs_sign)             # <<<<<<<<<<<<<<
 *     cdef int npair = params.shape[0]
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":204
 * def _olp_deriv_internal(list orbpairs_sign, double[:, :] params, long nspin):
 *     cdef long[:, :] orbpairs_sign_view = np.array(orbpairs_sign)
 *     cdef int npair = params.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int nelec = 2 * params.shape[0]
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":205
 *     cdef long[:, :] orbpairs_sign_view = np.array(orbpairs_sign)
 *     cdef int npair = params.shape[0]
 *     cdef int nelec = 2 * params.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int nparams = params.size
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":206
 *     cdef int npair = params.shape[0]
 *     cdef int nelec = 2 * params.shape[0]
 *     cdef int nparams = params.size             # <<<<<<<<<<<<<<
 *     cdef int num_orbpairs = params.shape[1]
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":207
 *     cdef int nelec = 2 * params.shape[0]
 *     cdef int nparams = params.size
 *     cdef int num_orbpairs = params.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":209
 *     cdef int num_orbpairs = params.shape[1]
 * 
 *     deriv = np.zeros(params.size)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":210
 * 
 *     deriv = np.zeros(params.size)
 *     cdef double[:] deriv_view = deriv             # <<<<<<<<<<<<<<
 *     # deriv = <double*>malloc(sizeof(double)*nparams)
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":216
 *     cdef Py_ssize_t p, q
 *     cdef int col_ind
 *     for i in prange(orbpairs_sign_view.shape[0], nogil=True, schedule='static'):             # <<<<<<<<<<<<<<
                ...
                #endif /* _OPENMP */
                {
                    ...
                    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_10; __pyx_t_9++){
                        if (__pyx_parallel_why < 2)
                        {
                            ...
                            /* "wfns/upgrades/cext_apg_parallel2.pyx":217
 *     cdef int col_ind
 *     for i in prange(orbpairs_sign_view.shape[0], nogil=True, schedule='static'):
 *         deriv_local = <double*>malloc(sizeof(double)*npair**2)             # <<<<<<<<<<<<<<
 *         for p in range(npair ** 2):
 ...
 */
                            ...
                            /* "wfns/upgrades/cext_apg_parallel2.pyx":218
 *     for i in prange(orbpairs_sign_view.shape[0], nogil=True, schedule='static'):
 *         deriv_local = <double*>malloc(sizeof(double)*npair**2)
 *         for p in range(npair ** 2):             # <<<<<<<<<<<<<<
 *             deriv_local[p] = 0
 ...
 */
                            ...
                            for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
                              ...
                              /* "wfns/upgrades/cext_apg_parallel2.pyx":219
 *         deriv_local = <double*>malloc(sizeof(double)*npair**2)
 *         for p in range(npair ** 2):
 *             deriv_local[p] = 0             # <<<<<<<<<<<<<<
 *         ryser_deriv(
 ...
 */
                            ...
                            /* "wfns/upgrades/cext_apg_parallel2.pyx":222
 *         ryser_deriv(
 *             params,
 *             orbpairs_sign_view[i, :nelec],             # <<<<<<<<<<<<<<
 *             orbpairs_sign_view[i, nelec],
...
__pyx_t_15 = __pyx_v_i;
                            ...
                            /* "wfns/upgrades/cext_apg_parallel2.pyx":223
 *             params,
 *             orbpairs_sign_view[i, :nelec],
 *             orbpairs_sign_view[i, nelec],             # <<<<<<<<<<<<<<
 *             nspin,
 ...
 */
                            ...
                            /* "wfns/upgrades/cext_apg_parallel2.pyx":220
 *         for p in range(npair ** 2):
 *             deriv_local[p] = 0
 *         ryser_deriv(             # <<<<<<<<<<<<<<
 *             params,
 *             orbpairs_sign_view[i, :nelec],
 */
                            __pyx_f_4wfns_8upgrades_18cext_apg_parallel2_ryser_deriv(__pyx_v_params, __pyx_t_14, (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_orbpairs_sign_view.data + __pyx_t_15 * __pyx_v_orbpairs_sign_view.strides[0]) ) + __pyx_t_16 * __pyx_v_orbpairs_sign_view.strides[1]) ))), __pyx_v_nspin, __pyx_v_deriv_local);
                            __PYX_XDEC_MEMVIEW(&__pyx_t_14, 0);
                            __pyx_t_14.memview = NULL;
                            __pyx_t_14.data = NULL;

                            /* "wfns/upgrades/cext_apg_parallel2.pyx":227
 *             deriv_local
 *         )
 *         with gil:             # <<<<<<<<<<<<<<
 ...
 */
                            {
                                ...
                                /*try:*/ {
                                  ...
                                  /* "wfns/upgrades/cext_apg_parallel2.pyx":228
 *         )
 *         with gil:
 *             for p in range(npair):             # <<<<<<<<<<<<<<
 *                 for q in range(npair):
 ...
 */
                                  ...
                                  for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_17; __pyx_t_13+=1) {
                                    ...
                                    /* "wfns/upgrades/cext_apg_parallel2.pyx":229
 *         with gil:
 *             for p in range(npair):
 *                 for q in range(npair):             # <<<<<<<<<<<<<<
 *                     j = orbpairs_sign_view[i, 2 * q]
 ...
 */
                                    ...
                                    for (__pyx_t_20 = 0; __pyx_t_20 < __pyx_t_19; __pyx_t_20+=1) {
                                      ...
                                      /* "wfns/upgrades/cext_apg_parallel2.pyx":230
 *             for p in range(npair):
 *                 for q in range(npair):
 *                     j = orbpairs_sign_view[i, 2 * q]             # <<<<<<<<<<<<<<
 *                     k = orbpairs_sign_view[i, 2 * q + 1]
 ...
 */
                                      ...
                                      /* "wfns/upgrades/cext_apg_parallel2.pyx":231
 *                 for q in range(npair):
 *                     j = orbpairs_sign_view[i, 2 * q]
 *                     k = orbpairs_sign_view[i, 2 * q + 1]             # <<<<<<<<<<<<<<
 *                     col_ind = nspin * j - j * (j + 1) // 2 + (k - j - 1)
 ...
 */
                                      ...
                                      /* "wfns/upgrades/cext_apg_parallel2.pyx":232
 *                     j = orbpairs_sign_view[i, 2 * q]
 *                     k = orbpairs_sign_view[i, 2 * q + 1]
 *                     col_ind = nspin * j - j * (j + 1) // 2 + (k - j - 1)             # <<<<<<<<<<<<<<
 *                     deriv_view[p * num_orbpairs + col_ind] += deriv_local[p * npair + q]
 ...
 */
                                      ...
                                      /* "wfns/upgrades/cext_apg_parallel2.pyx":233
 *                     k = orbpairs_sign_view[i, 2 * q + 1]
 *                     col_ind = nspin * j - j * (j + 1) // 2 + (k - j - 1)
 *                     deriv_view[p * num_orbpairs + col_ind] += deriv_local[p * npair + q]             # <<<<<<<<<<<<<<
 *         free(deriv_local)
 ...
 */
                            ...
                            /* "wfns/upgrades/cext_apg_parallel2.pyx":234
 *                     col_ind = nspin * j - j * (j + 1) // 2 + (k - j - 1)
 *                     deriv_view[p * num_orbpairs + col_ind] += deriv_local[p * npair + q]
 *         free(deriv_local)             # <<<<<<<<<<<<<<
 *     return deriv
 ...
 */
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":235
 *                     deriv_view[p * num_orbpairs + col_ind] += deriv_local[p * npair + q]
 *         free(deriv_local)
 *     return deriv             # <<<<<<<<<<<<<<
 */
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "wfns.upgrades.cext_apg_parallel2.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "wfns.upgrades.cext_apg_parallel2.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "wfns.upgrades.cext_apg_parallel2.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "wfns.upgrades.cext_apg_parallel2._memoryviewslice", /*tp_name*/
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_wfns_upgrades_cext_apg_parallel2, __pyx_k_wfns_upgrades_cext_apg_parallel2, sizeof(__pyx_k_wfns_upgrades_cext_apg_parallel2), 0, 0, 1, 0},
  {&__pyx_n_s_wfns_upgrades_cext_apg_parallel2_2, __pyx_k_wfns_upgrades_cext_apg_parallel2_2, sizeof(__pyx_k_wfns_upgrades_cext_apg_parallel2_2), 0, 0, 1, 1},
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_wfns__upgrades__cext_apg_parallel2) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "wfns.upgrades.cext_apg_parallel2")) {
      if (unlikely(PyDict_SetItemString(modules, "wfns.upgrades.cext_apg_parallel2", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "wfns/upgrades/cext_apg_parallel2.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 *     cdef int nelec = 2 * params.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4wfns_8upgrades_18cext_apg_parallel2_1_olp_internal, NULL, __pyx_n_s_wfns_upgrades_cext_apg_parallel2_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 184, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     cdef int npair = params.shape[0]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4wfns_8upgrades_18cext_apg_parallel2_3_olp_deriv_internal, NULL, __pyx_n_s_wfns_upgrades_cext_apg_parallel2_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 202, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init wfns.upgrades.cext_apg_parallel2", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init wfns.upgrades.cext_apg_parallel2");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
