...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "wfns.upgrades.cext_objective",
        "sources": [
            "wfns/upgrades/cext_objective.pyx"
        ]
    },
    "module_name": "wfns.upgrades.cext_objective"
}
END: Cython Metadata */
...
#define __PYX_HAVE__wfns__upgrades__cext_objective
#define __PYX_HAVE_API__wfns__upgrades__cext_objective
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'wfns.upgrades.cext_objective' */
...
static PyObject *__pyx_f_4wfns_8upgrades_14cext_objective_get_energy_one_proj_deriv(PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "wfns.upgrades.cext_objective"
extern int __pyx_module_is_main_wfns__upgrades__cext_objective;
int __pyx_module_is_main_wfns__upgrades__cext_objective = 0;

/* Implementation of 'wfns.upgrades.cext_objective' */
...
static PyObject *__pyx_pf_4wfns_8upgrades_14cext_objective_get_energy_one_proj_deriv(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_wfn, PyObject *__pyx_v_ham, PyObject *__pyx_v_pspace); /* proto */
...
/* "wfns/upgrades/cext_objective.pyx":9
...
static PyObject *__pyx_pw_4wfns_8upgrades_14cext_objective_1get_energy_one_proj_deriv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_4wfns_8upgrades_14cext_objective_get_energy_one_proj_deriv(PyObject *__pyx_v_wfn, PyObject *__pyx_v_ham, PyObject *__pyx_v_pspace, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "wfns/upgrades/cext_objective.pyx":10
 * @cython.wraparound(False)   # Deactivate negative indexing.
 * cpdef get_energy_one_proj_deriv(wfn, ham, list pspace):
 *     cdef double[:, ::1] one_int = ham.one_int             # <<<<<<<<<<<<<<
 *     # FIXME: move to Hamiltonian class
 ...
 */
  ...
  /* "wfns/upgrades/cext_objective.pyx":12
 *     cdef double[:, ::1] one_int = ham.one_int
 *     # FIXME: move to Hamiltonian class
 *     cdef double[:, ::1] two_int_ijij = np.ascontiguousarray(ham._cached_two_int_ijij)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "wfns/upgrades/cext_objective.pyx":13
 *     # FIXME: move to Hamiltonian class
 *     cdef double[:, ::1] two_int_ijij = np.ascontiguousarray(ham._cached_two_int_ijij)
 *     cdef double[:, ::1] two_int_ijji = np.ascontiguousarray(ham._cached_two_int_ijji)             # <<<<<<<<<<<<<<
 *     cdef double[:, :, :, ::1] two_int = ham.two_int
 ...
 */
  ...
  /* "wfns/upgrades/cext_objective.pyx":14
 *     cdef double[:, ::1] two_int_ijij = np.ascontiguousarray(ham._cached_two_int_ijij)
 *     cdef double[:, ::1] two_int_ijji = np.ascontiguousarray(ham._cached_two_int_ijji)
 *     cdef double[:, :, :, ::1] two_int = ham.two_int             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "wfns/upgrades/cext_objective.pyx":18
 *     cdef double overlap
 ...
 */
  ...
  /* "wfns/upgrades/cext_objective.pyx":19
 *     cdef double integral
 *     cdef double norm = 0
 *     cdef double energy = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "wfns/upgrades/cext_objective.pyx":21
 *     cdef double energy = 0
 * 
 *     cdef int pspace_size = len(pspace)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "wfns/upgrades/cext_objective.pyx":22
 * 
 *     cdef int pspace_size = len(pspace)
 *     cdef int wfn_nparams = wfn.nparams             # <<<<<<<<<<<<<<
 *     cdef int ham_nparams = ham.nparams
 ...
 */
  ...
  /* "wfns/upgrades/cext_objective.pyx":23
 *     cdef int pspace_size = len(pspace)
 *     cdef int wfn_nparams = wfn.nparams
 *     cdef int ham_nparams = ham.nparams             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "wfns/upgrades/cext_objective.pyx":29
 ...
 */
  ...
  /* "wfns/upgrades/cext_objective.pyx":30
 *     cdef np.ndarray[np.double_t, ndim=1] d_integral_ham
 *     cdef np.ndarray[np.double_t, ndim=1] d_norm = np.zeros(wfn_nparams)
 *     cdef np.ndarray[np.double_t, ndim=1] d_energy = np.zeros(wfn_nparams + ham_nparams)             # <<<<<<<<<<<<<<
 *     for i in range(pspace_size):
 ...
 */
  ...
  /* "wfns/upgrades/cext_objective.pyx":31
 *     cdef np.ndarray[np.double_t, ndim=1] d_norm = np.zeros(wfn_nparams)
 *     cdef np.ndarray[np.double_t, ndim=1] d_energy = np.zeros(wfn_nparams + ham_nparams)
 *     for i in range(pspace_size):             # <<<<<<<<<<<<<<
 *         overlap = wfn.get_overlap(pspace[i])
 ...
 */
  ...
  for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
    ...
    /* "wfns/upgrades/cext_objective.pyx":32
 *     cdef np.ndarray[np.double_t, ndim=1] d_energy = np.zeros(wfn_nparams + ham_nparams)
 *     for i in range(pspace_size):
 *         overlap = wfn.get_overlap(pspace[i])             # <<<<<<<<<<<<<<
 *         integral = np.sum(ham.integrate_sd_wfn(pspace[i], wfn))
 ...
 */
    ...
    /* "wfns/upgrades/cext_objective.pyx":33
 *     for i in range(pspace_size):
 *         overlap = wfn.get_overlap(pspace[i])
 *         integral = np.sum(ham.integrate_sd_wfn(pspace[i], wfn))             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "wfns/upgrades/cext_objective.pyx":35
 *         integral = np.sum(ham.integrate_sd_wfn(pspace[i], wfn))
 * 
 *         energy += overlap * integral             # <<<<<<<<<<<<<<
 *         norm += overlap ** 2
 ...
 */
    ...
    /* "wfns/upgrades/cext_objective.pyx":36
 * 
 *         energy += overlap * integral
 *         norm += overlap ** 2             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "wfns/upgrades/cext_objective.pyx":38
 *         norm += overlap ** 2
 * 
 *         d_overlap = wfn.get_overlap(pspace[i], True)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "wfns/upgrades/cext_objective.pyx":39
 * 
 *         d_overlap = wfn.get_overlap(pspace[i], True)
 *         d_integral_wfn = np.sum(ham.integrate_sd_wfn(pspace[i], wfn, wfn_deriv=True), axis=0)             # <<<<<<<<<<<<<<
 *         d_norm += 2 * overlap * d_overlap
 ...
 */
    ...
    /* "wfns/upgrades/cext_objective.pyx":40
 *         d_overlap = wfn.get_overlap(pspace[i], True)
 *         d_integral_wfn = np.sum(ham.integrate_sd_wfn(pspace[i], wfn, wfn_deriv=True), axis=0)
 *         d_norm += 2 * overlap * d_overlap             # <<<<<<<<<<<<<<
 *         d_energy[:wfn_nparams] += d_overlap * integral
 ...
 */
    ...
    /* "wfns/upgrades/cext_objective.pyx":41
 *         d_integral_wfn = np.sum(ham.integrate_sd_wfn(pspace[i], wfn, wfn_deriv=True), axis=0)
 *         d_norm += 2 * overlap * d_overlap
 *         d_energy[:wfn_nparams] += d_overlap * integral             # <<<<<<<<<<<<<<
 *         d_energy[:wfn_nparams] += overlap * d_integral_wfn
 ...
 */
    ...
    /* "wfns/upgrades/cext_objective.pyx":42
 *         d_norm += 2 * overlap * d_overlap
 *         d_energy[:wfn_nparams] += d_overlap * integral
 *         d_energy[:wfn_nparams] += overlap * d_integral_wfn             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "wfns/upgrades/cext_objective.pyx":44
 *         d_energy[:wfn_nparams] += overlap * d_integral_wfn
 * 
 *         d_integral_ham = np.sum(             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "wfns/upgrades/cext_objective.pyx":45
 * 
 *         d_integral_ham = np.sum(
 *             ham.integrate_sd_wfn_deriv(pspace[i], wfn, np.arange(ham.nparams)), axis=0             # <<<<<<<<<<<<<<
 *         )
 ...
 */
    ...
    /* "wfns/upgrades/cext_objective.pyx":47
 *             ham.integrate_sd_wfn_deriv(pspace[i], wfn, np.arange(ham.nparams)), axis=0
 *         )
 *         d_energy[wfn_nparams:] += overlap * d_integral_ham             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "wfns/upgrades/cext_objective.pyx":48
 *         )
 *         d_energy[wfn_nparams:] += overlap * d_integral_ham
 *     return energy, d_energy, norm, d_norm             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("wfns.upgrades.cext_objective.get_energy_one_proj_deriv", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_d_energy.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_4wfns_8upgrades_14cext_objective_1get_energy_one_proj_deriv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_4wfns_8upgrades_14cext_objective_1get_energy_one_proj_deriv(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_4wfns_8upgrades_14cext_objective_get_energy_one_proj_deriv(__pyx_self, __pyx_v_wfn, __pyx_v_ham, __pyx_v_pspace);
...
static PyObject *__pyx_pf_4wfns_8upgrades_14cext_objective_get_energy_one_proj_deriv(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_wfn, PyObject *__pyx_v_ham, PyObject *__pyx_v_pspace) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("get_energy_one_proj_deriv", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_4wfns_8upgrades_14cext_objective_get_energy_one_proj_deriv(__pyx_v_wfn, __pyx_v_ham, __pyx_v_pspace, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "wfns.upgrades.cext_objective.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "wfns.upgrades.cext_objective.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "wfns.upgrades.cext_objective.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "wfns.upgrades.cext_objective._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"get_energy_one_proj_deriv", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_4wfns_8upgrades_14cext_objective_1get_energy_one_proj_deriv, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_wfns__upgrades__cext_objective) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "wfns.upgrades.cext_objective")) {
      if (unlikely(PyDict_SetItemString(modules, "wfns.upgrades.cext_objective", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "wfns/upgrades/cext_objective.pyx":1
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * 
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init wfns.upgrades.cext_objective", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init wfns.upgrades.cext_objective");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
