...
import wfns.upgrades.speedup_objective
    ...
    def __init__(self, objective, variable_energy=False):
        ...
        if variable_energy:
            ...
            if objective.energy_type == 'variable':
                ...
                self.param_selection.load_mask_container_params(self.energy, True)
...
def least_squares(
    ...
    objective = SystemEquationsSystem(objective, variable_energy=variable_energy)
...
wfns.solver.system.least_squares = least_squares
