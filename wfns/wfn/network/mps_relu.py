"""Matrix Product State wavefunction with ReLU activation."""
from wfns.wfn.network.mps import MatrixProductState


class MPSReLU(MatrixProductState):
    """Matrix Product State wavefunction that applies ReLU activation after matrix multiplication.
