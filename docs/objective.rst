...
:class:`OneSidedEnergy <wfns.schrodinger.onesided_energy.OneSidedEnergy>`.
...
This objective is implemented in class
:class:`TwoSidedEnergy <wfns.schrodinger.twosided_energy.TwoSidedEnergy>`.
...
:class:`SystemEquations <wfns.schrodinger.system_nonlinear.SystemEquations>`.
